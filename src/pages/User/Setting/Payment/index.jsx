...
const Index = () => {
  ...
  const columns = [
    ...
    },
    {
      ...
      key: "updatedAt",
      render: (updatedAt) => (
        <div>{formatDate(updatedAt, "HH:mm dd-MM-yyyy")}</div>
      ),
    },
    {
      title: "Chi tiết",
          ...
          <Table
            ...
            expandable={{
              expandedRowRender: (record) => (
                <p className="m-0">
                  {record.orderItems[0]?.advertisingPackage?.description}
                </p>
              ),
        ...
        <div className="col-span-1 flex justify-end h-fit ">
          <div className=" border w-[80%] p-4 rounded-lg sh">
            ...
            <p className="text-[#717171] mt-2">
              ...
              theo Điều khoản dịch vụ, Điều khoản dịch vụ thanh toán, chính sách
              hủy và các biện pháp bảo vệ khác của chúng tôi. Tìm hiểu thêm
            </p>
          </div>
        </div>
      </div>
