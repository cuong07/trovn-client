...
import { CheckoutAds, CheckoutInvoice } from "@/components";
  ...
  return (
    <div className="grid grid-cols-2 container mx-auto h-screen">
      ...
      <div className="flex h-full items-center flex-col my-10 p-6 ">
        ...
        {buyPackage.packageType === PACKAGE_TYPE.INVOICE_PACKAGE && <CheckoutInvoice buyPackage={buyPackage} />}
        {buyPackage.packageType === PACKAGE_TYPE.ADS_PACKAGE && <CheckoutAds buyPackage={buyPackage} />}
      </div>
      <Modal
